...
const refeicoesDB = [
    ...
    { id: 2, nome: "Bifes de Frango Grelhados com Arroz e Salada", tags: ['frango', 'salada', 'arroz'], tempo: 'rapido', kidFriendly: true, desc: "Uma refeição leve, rápida e saudável. O frango grelhado é sempre uma aposta segura.", linkReceita: "https://www.saborintenso.com/f23/bifes-frango-grelhados-arroz-cenoura-3972/" },
    ...
    { id: 9, nome: "Nuggets Caseiros com Esparguete", tags: ['frango', 'massa', 'carne'], tempo: 'rapido', kidFriendly: true, desc: "A combinação preferida da pequenada para um dia especial, como o dos trampolins!", linkReceita: "https://www.continente.pt/receitas/nuggets-de-frango-com-esparguete/" },
    ...
    { id: 13, nome: "Esparguete com Camarão ao Alho", tags: ['massa', 'peixe'], tempo: 'rapido', kidFriendly: false, desc: "Rápido, aromático e com um toque mediterrânico. Ideal para um jantar a dois.", linkReceita: "https://www.saborintenso.com/f22/esparguete-camarao-alho-penca-4414/" },
    { id: 14, nome: "Empadão de Carne com Arroz", tags: ['carne', 'arroz'], tempo: 'normal', kidFriendly: true, desc: "Comida de conforto no seu melhor. O empadão é sempre um sucesso com toda a família.", linkReceita: "https://www.teleculinaria.pt/receitas/carne/empadao-de-carne-rapido/" }
];
    ...
    if (ingredientesSelecionados.length > 0) {
        ...
        if (refeicoesComIngredientes.length > 0) {
            poolFinal = refeicoesComIngredientes;
             ...
             alert("Não foram encontradas sugestões com essa combinação de filtros. Tente outras opções ou clique em 'Surpreenda-me!'.");
             return;
        }
    }
